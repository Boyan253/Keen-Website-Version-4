...
export default function BulgarianHeader() {
  ...
  const navItems = [
    { name: 'Какво правим', href: '#product' },
    { name: 'Как го правим', href: '#process' },
                ...
                >
                  ...
                  <div className="px-4 py-2">
                    <div className="flex items-center space-x-2 mb-3">
                      ...
                      <span className="text-sm font-medium text-keen-gray">Език</span>
                    </div>
                  ...
                  <div className="px-4 py-2">
                    <div className="flex items-center space-x-2 mb-3">
                      ...
                      <span className="text-sm font-medium text-keen-gray">Тема</span>
                    </div>
                    <div className="flex items-center space-x-2">
                      <button
                        onClick={toggleTheme}
          ...
          <div className="py-4 space-y-4 border-t border-gray-200">
            {navItems.map((item) => (
              <a
                key={item.name}
                href={item.href}
                className="block text-keen-gray font-medium hover:text-keen-blue transition-colors duration-300"
